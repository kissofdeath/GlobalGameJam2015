...
namespace UniArt.PixelScifiLandscape.Sample
{
    ...
    public class Proto_Character_Input : MonoBehaviour
    {
        ...
        public float Horizontal
        {
            ...
            {
                float fValue = 0.0f;
                if (Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.Q) || Input.GetKey(KeyCode.A) || (left < 0))
                {
                    fValue -= 1.0f;
                }

                if (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.D) || (right > 0))
                {
                    fValue += 1.0f;
                }
        ...
        public float Vertical
        {
            ...
            {
                float fValue = 0.0f;
                if (Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.S) || (down < 0))
                {
                    fValue -= 1.0f;
                }

                if (Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.Z) || Input.GetKey(KeyCode.W) || (up > 0))
                {
                    fValue += 1.0f;
                }
        ...
        public bool JumpInput
        {
            get
            {
                return Input.GetKey(KeyCode.Space) || Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt) || jump;
            }
        }
        ...
        public bool RunInput
        {
            get
            {
                ...
                return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl) || Input.GetKey(KeyCode.LeftCommand) || Input.GetKey(KeyCode.RightCommand) || Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift) || (run); //todo
            }
        }
